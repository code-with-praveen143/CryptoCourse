...
exports.verifyCoins = (req, res, next) => {
  User.findOne({
    ...
    exchange
      .getCurrentPrice(req.body.coin)
      .then(function (response) {
        const coinsSold =
          parseFloat(req.body.value) / parseFloat(response.data[0].price_usd);
...
exports.getUserValue = (req, res) => {
  User.findOne({
    ...
    exchange
      ...
      .then((response) => {
        userValue =
          userValue + userCoins.bitcoinCash * response.data[0].price_usd;
        return exchange.getCurrentPrice("bitcoinSV");
      })
      .then((response) => {
        userValue =
          userValue + userCoins.bitcoinSV * response.data[0].price_usd;
      ...
      .then((response) => {
        userValue =
          userValue + userCoins.binancecoin * response.data[0].price_usd;
